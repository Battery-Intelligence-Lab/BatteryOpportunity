...
plot(both.all.CC_list, optimal_lambda); hold on;
plot(both.all.CC_list, max_PIs);
...
% 
% x1 = 10.8;
% y1 = interp1(both.all.lambda_cal', both.all.LambdaExp_list(:,1), x1, method);
% 
% x2 = 9.41171875;
% y2 = interp1(both.all.lambda_cal', both.all.LambdaExp_list(:,2), x2, method);
% 
% x3 = 8.5;
% y3 = interp1(both.all.lambda_cal', both.all.LambdaExp_list(:,3), x3, method);
% 
% xN = 5.5;
% yN = interp1(both.all.lambda_cal', both.all.LambdaExp_list(:,iCC_to_plot(end)), xN, method);
% 
